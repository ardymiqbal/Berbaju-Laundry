...
if (strlen($username) < 10) {
  $pesan_error_user = "Username minimal 10 karakter<br>";
}
            ...
            <p align="center">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  ...
                  <input class="form-control <?= ($pesan_error_user) ? 'is-invalid' : ''; ?>" type="text" id="example-text-input" name="username" placeholder="Masukkan username (10 karakter)" minlength="10" maxlength="10" autofocus required value="<?= $username; ?>" />
