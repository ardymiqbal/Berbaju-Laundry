...
if (isset($_POST['login'])) {
  ...
  if (strlen($pass) < 8) {
    ...
    $login = mysqli_query(mysql: $conn, query: "SELECT * FROM tb_users WHERE username = '$username'");
    $cekUser = mysqli_num_rows($login); // tambahin ini
...
<html>
    ...
    <style>
        .accountbg {
            background-image: url('assets/images/bglaundry1.jpg');
                ...
                <div class="card-body">
                    ...
                    <div class="p-3">
                        ...
                        <form class="form-horizontal m-t-20" action="" method="POST">
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    <input class="form-control" type="password" required placeholder="Password" name="password" minlength="8">
                                </div>
                            </div>
