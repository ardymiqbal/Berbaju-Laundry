          ...
          <div class="card m-b-100">
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input class="form-control"type="text"id="example-text-input" name="pelanggannama" placeholder="Masukkan nama pelanggan" value="<?= $nama; ?>" pattern="[A-Za-z\s]+" title="Nama hanya boleh berisi huruf dan spasi" required autofocus maxlength="150"/>
                </div>
              </div>
